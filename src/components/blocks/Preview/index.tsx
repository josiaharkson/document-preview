...
const PreviewModal: React.FC<ModalProps> = (props) => (
  <Modal {...props} width={1240} className="shekel-preview-modal relative">
    {props.children}
    <button
      onClick={props.onCancel}
      className="absolute bottom-[-3rem] right-[45%] h-10 w-10 rounded-full bg-white p-1 shadow transition-all hover:bg-gray-100">
      <CloseOutlined />
    </button>
  </Modal>
);
    ...
    <div className="bg-[whitesmoke] w-screen h-screen flex items-center justify-center">
      ...
      <button
        ...
        <Typography.Paragraph
          ellipsis={{ rows: 1 }}
          className="!mb-0 !text-sm !text-[#344054] group-hover:!text-gray-500">
